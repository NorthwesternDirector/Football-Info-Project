...
export default () => {
  const IconFont = Icon.createFromIconfontCN({ // iconfront 字体导入
    scriptUrl: '//at.alicdn.com/t/font_1538571_tdnvtxl3pzd.js',
  })
  return (
  <PageHeaderWrapper title="ND学习时间" subTitle="我又不是个薯憨憨，当然会选择做前端">
    <Row gutter={24}>
      ...
      <Col span={8}>
        ...
        <Timeline>
          <Timeline.Item dot={ <IconFont type="icon-xuexiaogaikuang" />}>2013-09-01 中国地质大学（武汉）</Timeline.Item>
          ...
          <Timeline.Item dot={<IconFont type="icon-xuexiaogaikuang" />}>2017-09-01 中国海洋大学</Timeline.Item>
